...
//                 const expandedRow = button.parentElement.parentElement.nextElementSibling;
//                 expandedRow.classList.toggle('collapsed');
//                 button.textContent = expandedRow.classList.contains('collapsed') ? 'Expand' : 'Collapse';
//             });
//         });
...
function addRecord(){
 ...
 var Studentnum = table.lastElementChild.lastElementChild.previousElementSibling?.firstElementChild?.nextElementSibling?.innerHTML || "Student 0"
 console.log(Studentnum);
 var Budgetnum=table.lastElementChild.lastElementChild.previousElementSibling?.firstElementChild?.nextElementSibling?.nextElementSibling?.nextElementSibling?.nextElementSibling?.nextElementSibling?.nextElementSibling?.innerHTML || "12345"
 console.log(Budgetnum);
 
 if(Studentnum.split(" ")[1]>actual){
  actual=Studentnum.split(" ")[1];
 }
 if(actual1<Budgetnum){
  actual1=Budgetnum;
 }
